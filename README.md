...
Промо-лендинг на Nuxt 3 для продажи краски ELASTIC PRO. В проекте есть:

- SEO-одностраничник с SSR и статической генерацией;
- форма заявки;
- калькулятор расхода;
- визуализатор колеровки;
- FAQ;
- блок документов;
...
- сам лендинг, SEO, калькулятор, модалки, копирование номера и визуализатор будут работать;
